...
REFERENCE
  ...
  BROWSER : Nansi is meant to be used with its visual reference here: http://workmade.github.io/nansi.
  ...
  CLI : If you would rather keep it local, print the complete palette to standard output.
